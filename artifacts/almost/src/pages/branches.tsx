      ...
      <div className="w-full max-w-xl" style={{ paddingTop: "10vh", paddingBottom: "10vh" }}>
        ...
        {!loading && !error && branches.length > 0 && (
          <div>
            ...
            >
              These are the moments where everything could have gone differently. Pick one.
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1px" }}>
              {branches.map((branch) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = "rgba(26,26,26,0.04)";
                    e.currentTarget.style.paddingLeft = "0.75rem";
                    e.currentTarget.style.paddingRight = "0.75rem";
                    e.currentTarget.style.margin = "0 -0.75rem";
                    e.currentTarget.style.width = "calc(100% + 1.5rem)";
                  }}
                  onMouseLeave={(e) => {
