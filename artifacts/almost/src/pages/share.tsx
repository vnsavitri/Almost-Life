  ...
  if (invalid) {
    return (
      <main style={{ backgroundColor: "#BCD2EE", color: "#52050A", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1.5rem", padding: "2rem" }}>
        ...
        <button onClick={() => { window.location.href = "https://almost--vnsavitri.replit.app/"; }} style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.8125rem", backgroundColor: "#52050A", color: "#BCD2EE", border: "none", padding: "0.75rem 1.75rem", cursor: "pointer", letterSpacing: "0.04em" }}>
          Almost-life →
        </button>
      </main>
    );
    ...
    <main style={{ backgroundColor: "#52050A", color: "#BCD2EE", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
      ...
      <div style={{ width: "100%", maxWidth: "560px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          ...
          <button
            onClick={() => { window.location.href = "https://almost--vnsavitri.replit.app/"; }}
